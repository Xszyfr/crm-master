    ...
    try {
        ...
        if ($cl->connect_errno != 0) {
            ...
            if ($wszystko_ok == true) {
                ...
                if ($cl->query("INSERT INTO Pracownicy VALUES (NULL,'$login','$imie','$nazwisko','$email','$haslo_hash', '0', '$degree', '$edukacja', '$adres_zamieszkania', '$skills', '$notatki', now() )")) {
...
?>
      ...
      <div class="row">
        ...
        <div class="form-group has-feedback">
          ...
          <span class="glyphicon glyphicon-user form-control-feedback"></span>
          <?php
          if (isset($_SESSION['e_degree'])) {
            echo $_SESSION['e_degree'];
            unset($_SESSION['e_degree']);
          }
          ?>
        </div>
        <div class="form-group has-feedback">
          <input type="text" class="form-control" name="edukacja" placeholder="edukacja">
          <span class="glyphicon glyphicon-user form-control-feedback"></span>
          <?php
          if (isset($_SESSION['e_edukacja'])) {
            echo $_SESSION['e_edukacja'];
            unset($_SESSION['e_edukacja']);
          }
          ?>
        </div>

        <div class="form-group has-feedback">
          <input type="text" class="form-control" name="adres_zamieszkania" placeholder="adres_zamieszkania">
          <span class="glyphicon glyphicon-user form-control-feedback"></span>
          <?php
          if (isset($_SESSION['e_adres_zamieszkania'])) {
            echo $_SESSION['e_adres_zamieszkania'];
            unset($_SESSION['e_adres_zamieszkania']);
          }
          ?>
        </div>
        <div class="form-group has-feedback">
          ...
          <span class="glyphicon glyphicon-user form-control-feedback"></span>
          <?php
          if (isset($_SESSION['e_skills'])) {
            echo $_SESSION['e_skills'];
            unset($_SESSION['e_skills']);
          }
          ?>
        </div>
        <div class="form-group has-feedback">
          <input type="text" class="form-control" name="notatki" placeholder="notatki">
          <span class="glyphicon glyphicon-user form-control-feedback"></span>
          <?php
          if (isset($_SESSION['e_notatki'])) {
            echo $_SESSION['e_notatki'];
            unset($_SESSION['e_notatki']);
          }
          ?>
        </div>
        <div class="col-xs-4">
